...
point_ul =    int(0) , int(frame_y)
point_ur =    int(frame_x), int(frame_y)
point_or  =   int(frame_x * 0.65) , int(frame_y *0.6)
point_ol  =   int(frame_x * 0.35) , int(frame_y * 0.6)
...
def roi(img):
    ...
    shape = np.array([[int(0), int(y)], [int(x), int(y)], [int(0.65*x), int(0.6*y)], [int(0.35*x), int(0.6*y)]])
